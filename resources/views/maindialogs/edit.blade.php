...
<!--  !!{# !! Form::model($sizing, ['method' => 'PATCH','id'=>'mainPanelForm','name'=>'mainPanelForm', 'route' => ['compressor.update', $sizing->id]]) !!} -->
{!! Form::model($sizing, ['url' => 'inputFormSubmitted', 'id' => 'mainPanelForm', 'name' => 'mainPanelForm', 'target' => '_blank']) !!} 
<!--{!! Form::open(array('url' => 'inputFormSubmitted', 'id' => 'mainPanelForm', 'name' => 'mainPanelForm', 'target' => '_blank')) !!}-->
{{-- $inputs --}}
<h1>DATA INPUT SECTION:</h1>
  
  {!! Form::hidden('tid', $sizing->id ,array('id' => 'tid')) !!}
